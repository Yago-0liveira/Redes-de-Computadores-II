...
public class Principal extends Application {
  ...
  public void start(Stage primaryStage) throws Exception {
    ...
    primaryStage.getIcons().add(new Image(getClass().getResourceAsStream("visao/imagens/onda.png")));
    // //Adiciona um icone ao programa
    primaryStage.setTitle("Algoritmo de inundacao"); // Nomeia o programa
